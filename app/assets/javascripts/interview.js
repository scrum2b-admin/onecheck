...
$(".add_answer").live("click", function() {
  var class_answer =  $(this).prev('.answers')
  ...
  var html_new_answer = "<div class=\"list_answers\"><p>Answer No.<span class=\"no_answer\">"+ (answer_id) +"</span>: <a class=\"remove_answer\">Remove choice</a></p>"
...
$("#add_question").live("click",function(){
  ...
  html_new_question +=  "<div class=\"answers\">"
  html_new_question +=    "<p>Answer No.<span class=\"no_answer\">1</span>: <a class=\"remove_answer\">Remove choice</a></p>"
...
$(".remove_answer").live("click",function(){
 ...
 class_add_answer.attr("answer_max_number",number_answer);
  ...
  answers.find(".list_answers").each(function(){
